...
import AddMessageReducer from "./add_message_reducer";
  ...
  memories: __table(
    {
      ...
      constraints: [{ name: "memories_id_key", constraint: "unique", columns: ["id"] }],
    },
    MemoriesRow,
  ),
  messages: __table(
  ...
  sessions: __table(
    {
      name: "sessions",
      indexes: [{ name: "id", algorithm: "btree", columns: ["id"] }],
      constraints: [{ name: "sessions_id_key", constraint: "unique", columns: ["id"] }],
    },
    SessionsRow,
  ),
});
...
const reducersSchema = __reducers(
  __reducerSchema("add_message", AddMessageReducer),
